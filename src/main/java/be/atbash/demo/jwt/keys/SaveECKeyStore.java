...
public class SaveECKeyStore {

    public static void main(String[] args) {
        new File("./ec_private.p12").delete();
        new File("./ec_public.p12").delete();
        ...
        keyWriter.writeKeyResource(privateList.get(0), KeyResourceType.KEYSTORE, "./ec_private.p12", "ecKeyPassphrase".toCharArray(), "ecFilePassphrase".toCharArray());
        ...
        keyWriter.writeKeyResource(publicList.get(0), KeyResourceType.KEYSTORE, "./ec_public.p12", null, "ecFilePassphrase".toCharArray());
