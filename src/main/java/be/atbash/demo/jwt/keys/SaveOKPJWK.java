...
public class SaveOKPJWK {

    public static void main(String[] args) {
        new File("./okp_private.jwk").delete();
        new File("./okp_public.jwk").delete();
        ...
        keyWriter.writeKeyResource(privateList.get(0), KeyResourceType.JWK, "./okp_private.jwk");
        ...
        keyWriter.writeKeyResource(publicList.get(0), KeyResourceType.JWK, "./okp_public.jwk");
