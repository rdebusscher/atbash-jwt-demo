...
public class SaveOKPPEM {

    public static void main(String[] args) {
        new File("./okp_private.pem").delete();
        new File("./okp_public.pem").delete();

        ListKeyManager keyManager = new ListKeyManager(GenerateOKP.generateOKPKeys("demo"));
        ...
        keyWriter.writeKeyResource(privateList.get(0), KeyResourceType.PEM, "./okp_private.pem", "Testing".toCharArray());
        ...
        keyWriter.writeKeyResource(publicList.get(0), KeyResourceType.PEM, "./okp_public.pem");
