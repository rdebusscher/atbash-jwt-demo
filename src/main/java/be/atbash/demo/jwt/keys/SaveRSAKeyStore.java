...
public class SaveRSAKeyStore {

    public static void main(String[] args) {
        new File("./rsa_private.p12").delete();
        new File("./rsa_public.p12").delete();
        ...
        keyWriter.writeKeyResource(privateList.get(0), KeyResourceType.KEYSTORE, "./rsa_private.p12", "rsaKeyPassphrase".toCharArray(), "rsaFilePassphrase".toCharArray());
        ...
        keyWriter.writeKeyResource(publicList.get(0), KeyResourceType.KEYSTORE, "./rsa_public.p12", null, "rsaFilePassphrase".toCharArray());
