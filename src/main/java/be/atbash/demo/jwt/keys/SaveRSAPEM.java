...
public class SaveRSAPEM {

    public static void main(String[] args) {
        new File("./rsa_private.pem").delete();
        new File("./rsa_public.pem").delete();
        ...
        keyWriter.writeKeyResource(privateList.get(0), KeyResourceType.PEM, "./rsa_private.pem", "Testing".toCharArray());
        ...
        keyWriter.writeKeyResource(publicList.get(0), KeyResourceType.PEM, "./rsa_public.pem");
