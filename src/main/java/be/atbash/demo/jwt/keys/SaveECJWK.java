...
public class SaveECJWK {

    public static void main(String[] args) {
        new File("./ec_private.jwk").delete();
        new File("./ec_public.jwk").delete();
        ...
        keyWriter.writeKeyResource(privateList.get(0), KeyResourceType.JWK, "./ec_private.jwk");
        ...
        keyWriter.writeKeyResource(publicList.get(0), KeyResourceType.JWK, "./ec_public.jwk");
